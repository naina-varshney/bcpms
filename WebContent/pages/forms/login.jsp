...
<%
	...
	if ((user_id.charAt(0) == 'A') && (user_id.charAt(1) == 'B')) {
		...
		if (rs.next()) {
			...
			//response.sendRedirect("../../pages/dashboard/studentdashboard.html");
		...
		if (rs.next()) {
				...
				if (rs.getBoolean(3)) {
					...
					//response.sendRedirect("../../pages/dashboard/coordinatordashboard.html");
				} 
				else {
					response.getWriter().write("../../pages/dashboard/teacherdashboard.html");
					//response.sendRedirect("../../pages/dashboard/teacherdashboard.html");
				}
			}
		...
		if(rs.next()) {
			response.getWriter().write("../../pages/dashboard/admindashboard.html");
				//response.sendRedirect("../../pages/dashboard/admindashboard.html");
			} else {
				response.getWriter().write("unauthorized");
			}
		response.getWriter().close();
