...
<head>
  ...
  <title>BCPMS | Diploma Course</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Diplomacourses</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Diploma Courses</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
...
<%
                        ...
                        if(id!=null)
                        {
                            PreparedStatement ps=new Conn().con.prepareStatement("select name,duration,fee from course_details where type='diploma'or type='Diploma' ");
